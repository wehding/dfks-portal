...
begin
  for item in
    select * from (values
      ...
      ('rights_allocations', 'rights_allocations_run_id_fkey', $constraint$FOREIGN KEY (run_id) REFERENCES calculation_runs(id) ON DELETE CASCADE$constraint$),
      ...
      ('rights_claims', 'rights_claims_run_id_fkey', $constraint$FOREIGN KEY (run_id) REFERENCES calculation_runs(id)$constraint$),

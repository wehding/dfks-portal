...
function MineVisningerContent() {
  ...
  return <div className="space-y-6">
    <PortalPageHeader title="Mine visninger" subtitle="Indberet manuelle visninger og følg dialogen med DFKS" actions={<Button onClick={() => setCreateOpen(true)}><Plus className="mr-2 h-4 w-4" />Indberet visning</Button>} />
    ...
    <ListResultSummary filteredCount={filteredClaims.length} totalCount={claims.length} loading={loading} />

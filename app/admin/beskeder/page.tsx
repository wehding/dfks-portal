...
export default function AdminInboxPage() {
  ...
  const sendNew = async () => {
    ...
    const label = selectedRecipients.length === 1 ? "1 modtager" : `${selectedRecipients.length} modtagere`;
    if (!window.confirm(`Send beskeden til ${label}? Hver modtager får sin egen private tråd.`)) return;
    setBusy(true);

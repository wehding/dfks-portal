...
const HELP_BY_SECTION: Record<string, AdminHelpContent> = {
  ...
  kontrakter: { title: "Hjælp til kontrakter", intro: "Find, forbind og validér organisationens kontrakter.", topics: [{ title: "Statusser", body: "Kladde betyder, at kontrakten kræver gennemgang. Valideret betyder, at den kan bruges i systemets videre udbetalings- og statistikflow." }, { title: "Forbind med værk", body: "Søg først efter et eksisterende værk. Kontrakttype, overenskomst og datoer redigeres efter værkforbindelsen." }, { title: "Serieafsnit", body: "Vælg de afsnit kontrakten gælder. En kontrakt kan gælde enkelte afsnit eller hele sæsonen." }, { title: "Filtre og massehandlinger", body: "Et aktivt rettighedshaverfilter deles med Værksadministration. Markér flere kontrakter for samlet validering; permanent sletning bør kun bruges ved fejloprettelser." }] },
  vaerker: { title: "Hjælp til værker", intro: "Administrér fælles værkdata og de tilknyttede personer.", topics: [{ title: "Til godkendelse", body: "Nye værker og rettelser skal gennemgås, før oplysningerne bruges som endelige værksdata." }, { title: "Serier", body: "Fold en sæson ud for at se afsnit. Redigér sæsonen for fælles data og hvert afsnit for individuelle krediteringer." }, { title: "Rettighedshavere", body: "Rolle og andel gemmes på relationen mellem værket og rettighedshaveren. Andelen er informativ og behøver ikke summere til 100 %." }, { title: "Kontrakter", body: "Under tilknyttede kontrakter kan du åbne rettighedshaverens konkrete kontrakt eller forbinde en ny." }] },

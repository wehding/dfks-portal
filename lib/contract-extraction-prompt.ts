...

{
  ...
  "overenskomst": "én af: de4-fiktion, faf-fiktion, faf-dokumentar, faf-tv-ansat, faf-tv-freelance, dj-tv, metal, ingen (string | null). VIGTIGT: Flere overenskomster hedder begge \"Fiktionsoverenskomsten\" (fx både De4's og FAF's), men er indgået mellem forskellige parter. Afgør ALDRIG kun ud fra ordet \"fiktion\" — læs hvilken organisation overenskomsten konkret er indgået mellem Producentforeningen og (typisk angivet i overskriften/indledningen, fx \"Overenskomst mellem Producentforeningen og FAF\" → faf-fiktion, \"...og De4\" → de4-fiktion). \"de4-fiktion\" kræver at De4 (Dansk Filmfotograf Forbund/Dansk Filmklipperselskab/Danske Scenografer/Dansk Journalistforbund) er den navngivne modpart — ikke blot at ordet \"fiktion\" indgår. Ældre eller formelle kontraktskabeloner bruger ofte organisationens fulde, formelle navn i stedet for en moderne forkortelse — genkend disse som samme organisation: FAF = \"Film- og TV-Arbejderforeningen\"; \"Kort- og dokumentarfilmoverenskomsten mellem Film- og TV-arbejderforeningen og Danske Film- og TV-Producenter\" = faf-dokumentar, uanset at ordet \"FAF\" ikke nævnes eksplicit. Match generelt på den navngivne organisations fulde, formelle navn, ikke kun på en genkendt forkortelse.",
  ...
  "productionType": "én af: feature, tvSeries, documentary, docSeries, short, tvEntertainment, reality, other eller null. Udfyld kun når produktionstypen fremgår eksplicit eller kan udledes sikkert af kontrakten. Gæt ikke ud fra producent, titel eller distributionsplatform. Hvis kontrakten nævner afsnit/episode/sæson uden at skelne mellem fiktion og dokumentar, returnér null.",
  ...
  "svod": "har kontrakten en SPECIFIK SVOD-rettighedsklausul — fx en eksplicit henvisning til SVOD-rammeaftalen mellem Producentforeningen og kunstnerorganisationerne, Create Denmark, Copydan-kompensation for streaming (fx for Netflix/YouSee), eller at produktionen er bestilt direkte til en streamingtjeneste? Svar IKKE true, blot fordi 'streamingtjenester' nævnes som ét blandt flere distributionsled i en generel/bred rettighedsoverdragelse (fx en opremsning af biograf, tv, streaming, on demand osv. som eksempler på udnyttelsesformer) — det er standard boilerplate-sprog, ikke en SVOD-aftale. (boolean)",
  "copydan": "true ved Copydan, Copy-Dan, Copydan Kompensation, aftalelicens, privatkopiering, kollektivt forvaltningsselskab, §§ 13, 13a, 17, 30a, 35, 39-46a, 50 stk. 1 eller 2 eller lignende vederlagsforbehold. (boolean)",

...

{
  ...
  "salary": "UGELØN som tal uden valuta (number | null). Regler: eksplicit ugepris vinder; dagssats * 5; timesats * 37 medmindre 40 timer/uge står tydeligt; lump sum kun hvis periode er tydelig; ignorer moms/subtotal/fakturatotal/feriepenge/sociale omkostninger; tillæg lægges ikke oven i grundløn. Kontrakten kan indeholde flere alternative lønformer i skabelonen (fx både en ugeløns-klausul og en klumpsum-klausul) — brug kun den faktisk anvendte/udfyldte klausul, ignorér ubrugte alternative betalingsformer i skabelonen, selvom de også nævner et beløb.",

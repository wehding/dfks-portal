...

{
  ...
  "signatureStatus": "én af: yes, no, unknown. yes kun når kontrakten tydeligt er underskrevet; no når underskriftsfeltet tydeligt er tomt; ellers unknown",
  "signatureDate": "underskriftsdato ISO 8601 hvis den fremgår (string | null)",
  "signatureEvidence": "kort tekstnær evidens for underskriftsstatus uden personfølsomme oplysninger (string | null)",

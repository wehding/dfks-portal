...

{
  ...
  "prolongationWeeks": "antal EKSTRA optionsuger/prolongationsuger som tal, hvis det fremgår eksplicit eller kan beregnes sikkert (number | null). Skeln mellem ekstra uger og en samlet maksimumsramme: Hvis medarbejderen fx er engageret i 19 uger 'med mulighed for prolongation i indtil 24 uger', er 24 den samlede ramme, og prolongationWeeks er 24 - 19 = 5. Skriv beregningen i prolongationNote. Formuleringen 'op til 2 ugers prolongation' betyder derimod 2 ekstra uger. Bestemmelsen kan stå i uger ELLER dage — hvis den står i dage, divider med 5 og afrund til nærmeste tal. Værdien kan være udfyldt i en skabelon med linjer/understregninger omkring tallet (fx '___4___ dage') — se bort fra understregninger og udfyld ud fra selve tallet. Eksempler: 'op til 2 ugers prolongation' → 2. 'mulighed for prolongation i ___4___ dage' → 1 (4 dage / 5). 'prolongation i 10 arbejdsdage' → 2.",

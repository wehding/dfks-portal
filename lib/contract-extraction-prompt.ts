...

{
  ...
  "otherSupplements": "liste over alle tillæg der ikke allerede er dækket af personalSupplement — inkl. efterarbejde/postproduktion. Hvert tillæg som en separat post — slå ikke flere tillæg sammen. AFGØRENDE — HYPPIGT MØNSTER: lønafsnit viser ofte FLERE linjer der summerer til en samlet ugeløn (fx 'Normalløn: X, Personligt tillæg: Y, Fast tillæg for over-/forskudttid: Z, Således samlet ugeløn: X+Y+Z'). I så fald er det IKKE nok kun at sætte salary til totalbeløbet — HVER linje ud over selve grundlønnen SKAL udtrækkes som sin egen post her (personligt tillæg → personalSupplement-feltet; alt andet → en post i denne liste). Undlad ALDRIG at udtrække en linje blot fordi den indgår i en sum. For hvert tillæg: category (overtidstillaeg=fast aftalt overtidskompensation, IKKE optalte timer; genetillaeg=ubekvemme tidspunkter/forskudttid/nat — inkl. 'over- og forskudttid'; weekend_helligdag=weekend eller helligdag, IKKE sammenlagt med genetillaeg; rejsetillaeg=rejsegodtgørelse; udetillaeg=lokationstillæg; diaeter=kost og logi; udstyr_telefon=udstyrs/telefongodtgørelse; preproduktion=pre-produktionstillæg; efterarbejde=efterarbejde/postproduktion; fast_uspecificeret=fast tillæg uden specificeret årsag; andet=fangkategori); amount som tal eller null; unit fx 'pr. uge', 'pr. dag', 'engangsbeløb'; note: kort begrundelse for kategorivalget når det ikke er indlysende; sourceText: citat fra kontrakten med [sX_cY]-tag forrest. (array | null)",

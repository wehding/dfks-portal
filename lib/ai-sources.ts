...
export const SOURCES_SCHEMA_PROMPT = `    "_sources": {
      "workTitle": "EKSAKT tekststreng der nævner produktionens/filmens titel — kopiér sætningen med titlen, husk altid tagget [sX_cY]/[pN] forrest, f.eks. '[s1_c9] produktionen 'MIN FILM'' eller '[s1_c9] arbejdet med serien \"TITLEN\"' — max 80 tegn eller null",
      ...
      "salary": "EKSAKT tekststreng fra kontrakten der indeholder DET FAKTISKE, GÆLDENDE honorar — kopiér sætningen der nævner beløbet, husk altid tagget [sX_cY]/[pN] forrest, f.eks. '[s1_c14] grundløn på __14.637__ DKK pr. uge' eller '[s1_c14] honorar på 45.000 kr. pr. måned' — max 120 tegn eller null. VIGTIGT — skabeloner har ofte flere alternative betalingsklausuler (fx både A. Ugeløn og B. Klumpsum), hvor kun én er udfyldt: en klausul med KUN en streg/understregning og INGEN tal i beløbsfeltet (fx 'løn på _' eller 'løn på ___') er UBRUGT — citér ALDRIG en sådan klausul, uanset hvor tæt den ellers ligner en lønbestemmelse. Citér udelukkende den klausul, hvor der rent faktisk står et konkret tal. SÆRLIGT VED KLUMPSUM/LUMP SUM OMREGNET TIL UGELØN: hvis den udtrukne salary-værdi er BEREGNET (fx en klumpsum-totalbeløb divideret med antal uger, ikke et eksplicit ugebeløb angivet direkte i kontrakten), findes der INGEN sætning i kontrakten, der nævner det beregnede tal — citér i stedet den klausul, der indeholder selve KLUMPSUM-totalbeløbet, IKKE en opdigtet sætning med det udregnede ugebeløb. VIGTIGT: citatet skal, ligesom alle andre citater, starte med klausulens eget [sX_cY]/[pN]-tag — kopiér det inline fra teksten, du læser, udelad det ALDRIG, heller ikke i dette særtilfælde. Fx: \"[s2_c5] Medarbejderen modtager en samlet løn på DKK 288.000 for Fiktionsproduktionen.\"",
      ...
      "pension": "EKSAKT og UNIK tekststreng der kun findes i DEN FAKTISK GÆLDENDE pensionsklausul. Citatet SKAL altid inkludere selve DKK/kr.-beløbet efter procentsatsen — stop ALDRIG ved parentesen eller lige efter procenttegnet. Et citat uden beløb er ubrugeligt, selvom det er unikt for det korrekte afsnit. Korrekt eksempel: '[s1_c15] pensionsbidrag (9,5 % af grundlønnen) 1330 DKK' — forkert eksempel: '[s1_c15] pensionsbidrag (9,5 % af grundlønnen)' (stopper for tidligt, mangler beløbet). Husk altid tagget [sX_cY]/[pN] forrest, ligesom i disse eksempler. Max 60 tegn eller null. VIGTIGT — skabeloner gentager ofte pensionsformuleringen i en alternativ klausul (fx B. Fast løn/klumpsum): en gentagelse med KUN streger/understregninger og INTET konkret beløb (fx 'pensionsbidrag (9,5 %) ___DKK') er UBRUGT — citér ALDRIG en sådan gentagelse. Citér udelukkende fra den klausul, hvor der rent faktisk står et konkret kr.-beløb.",
      ...
      "supplements": "EKSAKT tekststreng der indeholder afsnittet om personlige tillæg inkl. selve beløbet — kopiér fra 'personlige tillæg' og frem til beløbet, husk altid tagget [sX_cY]/[pN] forrest, f.eks. '[s1_c16] personlige tillæg: 2.500 DKK' eller '[s1_c16] følgende personlige tillæg:___1.586' — max 60 tegn eller null. VIGTIGT — skabeloner gentager ofte tillægsformuleringen i en alternativ klausul (fx B. Fast løn/klumpsum): en gentagelse med KUN streger/understregninger og INTET konkret beløb er UBRUGT — citér ALDRIG en sådan gentagelse. Citér udelukkende fra den klausul, hvor der rent faktisk står et konkret kr.-beløb.",
      ...
      "otherSupplements": "EKSAKT tekststreng der indeholder afsnittet om andre tillæg (ikke personlige tillæg) — kopiér den sætning der nævner tillægget, husk altid tagget [sX_cY]/[pN] forrest, f.eks. '[s1_c20] tillæg for særlige opgaver' eller '[s1_c20] øvrige tillæg: 500 kr.' — max 80 tegn eller null",
      ...
      "dates": "EKSAKT tekststreng der viser ansættelsesperioden — kopiér sætningen med start- og slutdato, husk altid tagget [sX_cY]/[pN] forrest, f.eks. '[s1_c11] fra den 26. august til 24. november 2024' eller '[s1_c11] ansættelsesperioden er 01.01.2024 - 31.03.2024' — max 80 tegn eller null",
      "dates_clause_id": "Kopiér tagget fra begyndelsen af den linje du citerer i dates — direkte aflæsning. Null hvis ikke annoteret.",
      "workingWeeks": "EKSAKT og KORT tekststreng der viser det SAMLEDE antal uger — KUN selve ugetallet med umiddelbar kontekst, husk altid tagget [sX_cY]/[pN] forrest, f.eks. '[s1_c11] engageret i 9 uger', '[s1_c11] 17,6 weeks', '[s1_c11] i alt 11,6 uger' — STOP før datoer og andre oplysninger. Max 30 tegn. Null hvis intet samlet ugetal findes.",
      ...
      "svod": "Kopiér den KOMPLETTE tekstpassage der er mest relevant for en manuel SVOD/streaming-vurdering — START altid fra afsnittets allerførste ord. Inkluder hele afsnittet. Max 400 tegn. Prioritér i følgende rækkefølge: (1) Et afsnit der eksplicit nævner SVOD, Create Denmark, streamingtjenester eller on-demand-distribution. (2) Hvis intet eksplicit SVOD-afsnit: find den generelle rettighedsoverdragelses-paragraf der regulerer producentens rettigheder til digital distribution eller genudsendelse — dette er det relevante sted for manuel kontrol, selv om SVOD ikke nævnes. Husk altid tagget [sX_cY]/[pN] forrest i citatet. Null KUN hvis kontrakten slet ikke har tekst om rettigheder, distribution eller producentens brug af materialet.",
      "svod_clause_id": "Kopiér tagget fra begyndelsen af den linje du citerer i svod — direkte aflæsning. Null hvis ikke annoteret.",
      "royalty": "Kopiér den KOMPLETTE tekstpassage FRA KONTRAKTEN der omhandler royaltybetaling — inkl. indirekte formuleringer som 'Producenten afregner royalties til [overenskomst] jf. overenskomst' eller 'Leverandøren vil være berettiget til en andel af disse royalties'. KUN hvis adskilt fra SVOD/streaming-afsnittet. Max 400 tegn. VIGTIGT: hvis royaltyprocenten er UDLEDT fra overenskomstkonteksten uden at stå eksplicit i kontrakten, citér i stedet den sætning i kontrakten der henviser til/inkorporerer overenskomsten (fx '[s1_c3] ansættelsen sker i henhold til [overenskomst]', husk altid tagget forrest) — SÆT ALDRIG selve procenttallet ind som citat, det er ikke en tekstpassage og kan ikke highlightes i dokumentet. Null hvis hverken royaltytekst eller overenskomst-henvisning findes.",
      ...
      "prolongation": "EKSAKT tekststreng der viser prolongations-/optionsklausulen — kopiér sætningen der nævner antal optionsuger/-dage og eventuel ferieperiode, husk altid tagget [sX_cY]/[pN] forrest, fx '[s1_c11] op til 2 ugers prolongation', '[s1_c11] mulighed for forlængelse med 3 uger', eller '[s1_c11] mulighed for prolongation i ___4___ dage' (inkl. evt. understregninger/udfyldningslinjer omkring tallet, som de faktisk står i kontrakten). Max 120 tegn eller null.",
      ...
      "creditedRoles": "EKSAKT tekststreng fra kontrakten der nævner klipperens/leverandørens kreditering — kopiér HELE sætningen, uanset formulering. Almindelige varianter (husk altid tagget [sX_cY]/[pN] forrest, fx '[s2_c6] Der er aftalt følgende vedrørende kreditering: NAVN - ROLLE'): 'krediteres som Klipper', 'Film Editor credit', 'kreditering: Supervising Editor'. Citér altid den fulde sætning, selvom den blot lister navn og rolle uden en beskrivende sætning omkring — max 150 tegn eller null",

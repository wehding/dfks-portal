...
Brug null hvis et felt ikke kan bestemmes.`
    ...
    const udviklingsMatch = kontraktTekst.match(
        /klipper\s*\(udvikling\)|film\s+editor\s*\(development\)|udviklingskontrakt|\budviklingsfase\b|i\s+udviklingsfasen|\bi\s+udvikling\b|optionsaftale|development\s+deal|development\s+agreement/i
    )
